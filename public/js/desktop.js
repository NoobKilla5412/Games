...
function loadDesktopFiles() {
  ...
  desktopFiles.forEach((file) => {
    ...
    tempElem.addEventListener("dblclick", () => {
      ...
      //   openApp(
      //     "file:///home/chronos/u-80fe660182c0fb240a4aa8897e206d40598ab3be/MyFiles/1%20School8%20S2/30-Minute%20OS/" +
      //       file
      //         .split("/")
      ...
      if (file.endsWith(".mp4"))
        openApp(
          "data://video/mp4," + localStorage.getItem("file:" + file),
    ...
    tempElem.addEventListener("contextmenu", (e) => {
      ...
      document.getElementById(`edit-${file}`).addEventListener("click", () => {
        openApp(
          `file:///home/chronos/u-80fe660182c0fb240a4aa8897e206d40598ab3be/MyFiles/1%20School8%20S2/30-Minute%20OS/textEditor/index.html?file=${file}`,
          "Text Editor"
        );
        fileContextmenu.classList.toggle("hide", true);
        desktopContextmenu.classList.toggle("hide", true);
