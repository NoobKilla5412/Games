...
(function (OS) {
    ...
    (function (windowMngr) {
        ...
        function openApp(app, appName) {
            var i = windowMngr.windows.length;
            ...
            windowMngr.windows.push({ frame, i, maximized: false });
            windowsElem.append(frame);
            dragElement(frame, i);
        }
        windowMngr.openApp = openApp;
        function dragElement(elmnt, i) {
            ...
            function elementDrag(e) {
                if (windowMngr.windows[i].maximized) {
        ...
        function maximize(frame, i, move = true) {
            if (windowMngr.windows[i].maximized) {
                ...
                frame.style.resize = "both";
                frame.style.border = "1px lightblue solid";
                windowMngr.windows[i].maximized = false;
            }
            else {
                ...
                windowMngr.windows[i].maximized = true;
            }
        }
    })(windowMngr = OS.windowMngr || (OS.windowMngr = {}));
})(OS || (OS = {}));
